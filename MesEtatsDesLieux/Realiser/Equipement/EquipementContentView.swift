...
class EquipementContentView: UIView, UIContentView {
    ...
    private var currentConfiguration: EquipementContentConfiguration!
    var configuration: UIContentConfiguration {
        get {
            currentConfiguration
        }
        set {
        guard let newConfiguration = newValue as? EquipementContentConfiguration else { return }
        self.apply(configuration: newConfiguration)
        }
    }
    
    init (configuration: EquipementContentConfiguration) {
...
private extension EquipementContentView {
    private func loadNib(configuration: EquipementContentConfiguration) {
        // 3
        // Load SFSymbolNameContentView.xib by making self as owner of SFSymbolNameContentView.xib
        Bundle.main.loadNibNamed("\(EquipementContentView.self)", owner: self, options: nil)
    ...
    private func apply(configuration: EquipementContentConfiguration) {
